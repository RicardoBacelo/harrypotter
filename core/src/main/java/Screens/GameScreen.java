...
import ui.Inventory;
import com.bd2r.game.Observer.Locket;  // Certifique-se de usar este import exato
import ecs.Entity;
...
public class HagridHouseScreen implements Screen {
    ...
    public void show() {
        ...
        // 8) Se você quiser usar coinManager, silverKeyManager, goldenKeyManager, crie aqui:
        // coinManager       = new CoinManager();
        // silverKeyManager  = new SilverKeyManager();
        // goldenKeyManager  = new GoldenKeyManager();

        // 9) Centraliza a câmera no meio do mapa (opcional)
    ...
    public void render(float delta) {
        ...
        if (pos != null) {
            // Aqui você poderia chamar movementSystem.update(...) se quisesse mover o player
            // e também coinManager.updateAndNotifyCoins(pos.x, pos.y, inventory), etc.
        }
        ...
        if (pos != null && locketManager != null) {
            ...
            // Se seu LocketManager não tiver método .render(), desenhe manualmente:
            // float origW = locketTexture.getWidth(), origH = locketTexture.getHeight();
            // float scale = 0.1f;
            // batch.draw(
            //   locketTexture,
    ...
    public void dispose() {
        ...
        // Se tiver coinManager, silverKeyManager, goldenKeyManager, chame dispose() neles aqui também
    }
}
